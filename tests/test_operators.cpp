...
TEST_CASE("Perturbation", "[operators]")
{
    auto el0 = SymEngine::make_rcp<const Tinned::Perturbation>(
        std::string("EL"),
        SymEngine::integer(1)
    );
    auto el1 = SymEngine::make_rcp<const Tinned::Perturbation>(
        std::string("EL"),
        SymEngine::rational(2, 5)
    );
    auto el2 = SymEngine::make_rcp<const Tinned::Perturbation>(
        std::string("EL"),
        SymEngine::real_double(1.5)
    );
...
TEST_CASE("ElectronicState", "[operators]")
{
}

TEST_CASE("OneElecOperator", "[operators]")
{
}

TEST_CASE("TwoElecOperator", "[operators]")
{
}

TEST_CASE("ExchCorrEnergy", "[operators]")
{
}

TEST_CASE("ExchCorrPotential", "[operators]")
{
}

TEST_CASE("NonElecFunction", "[operators]")
{
}

TEST_CASE("TemporumOperator", "[operators]")
{
}

TEST_CASE("TemporumOverlap", "[operators]")
{
}
